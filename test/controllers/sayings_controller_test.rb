...
class SayingsControllerTest < ActionController::TestCase
  ...
  test "should create saying" do
    assert_difference('Saying.count') do
      post :create, saying: { downs: @saying.downs, hits: @saying.hits, saying: @saying.saying, ups: @saying.ups }
    end
  ...
  test "should update saying" do
    patch :update, id: @saying, saying: { downs: @saying.downs, hits: @saying.hits, saying: @saying.saying, ups: @saying.ups }
    assert_redirected_to saying_path(assigns(:saying))
  end
